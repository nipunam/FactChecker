...
class DLFactory(object):
	predictor = predictors.Predictor.from_path("https://s3-us-west-2.amazonaws.com/allennlp/models/bidaf-model-2017.09.15-charpad.tar.gz")
	@staticmethod
	def predict_answer(question,passage):
		result = DLFactory.predictor.predict(
          passage= passage,
          question= question
        )
